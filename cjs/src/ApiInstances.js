...
var ApisInstance = function () {
    ...
    ApisInstance.prototype.connect = function connect(cs, connectTimeout) {
        ...
        this.init_promise = this.ws_rpc.login(rpc_user, rpc_password).then(function () {
            ...
            _this2._asset = new _GrapheneApi2.default(_this2.ws_rpc, "asset");
            ...
            var initPromises = [db_promise, _this2._net.init(), _this2._hist.init(), _this2._asset.init()];
    ...
    ApisInstance.prototype.asset_api = function asset_api() {
        return this._asset;
    };
